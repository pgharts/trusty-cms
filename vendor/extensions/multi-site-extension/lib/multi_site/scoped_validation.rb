module MultiSite::ScopedValidation
  ...
  module ValidatesUniquenessOfWithSite
  ...
  def self.included(base)
    base.class_eval do
      prepend ValidatesUniquenessOfWithSite
      prepend DatabaseExists
    end
  end

  module DatabaseExists
    def database_exists?
...
ActiveRecord::Validations::ClassMethods.include MultiSite::ScopedValidation
