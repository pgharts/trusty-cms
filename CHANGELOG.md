...
* No need to boot TrustyCms during instance generation [jsntv200]
...
* Fixed bootstrap so that migrations run from TrustyCms.root/db/migrate [William Ross]
...
* Alter the environment path when running tests from TRUSTY_CMS_ROOT [Jim Gay]
...
* Don't run TrustyCms initializations if TrustyCms.root is the same as Rails.root [William Ross]
...
* Add TrustyCms.config method and radiant_config.rb initializer [William Ross]
...
* Add import/export tasks for TrustyCms::Config [Jim Gay]
* Set TrustyCms::Config to cache info in the Rails.cache [Jim Gay]
...
* Deprecate ResponseCache, add TrustyCms::Cache based on Rack::Cache. [Sean Cribbs]
...
* Avoid bootstrap errors related to TrustyCms::Config by checking for table existence. [Sean Cribbs]
...
* Override spec:integration task and rescope some spec task options to TRUSTY_CMS_ROOT. [Sean Cribbs]
...
* Change order of extension paths to prefer project extensions over TrustyCms's. [John Muhl]
...
* Make sure extension view paths override TrustyCms view paths. [Josh French]
...
* Add autotest support for TrustyCms and extensions. [Josh French]
...
* Support database templates in a TrustyCms instance. [Benny Degezelle]
...
* Remove duplicate specs and move TrustyCms::ExtensionMigrator? spec to proper location. [Sean Cribbs]
...
* Add specs for TrustyCms::Extension and TrustyCms::Taggable. [Sean Cribbs]
...
* Add spec for TrustyCms::AdminUI and Users scenario. [Sean Cribbs]
...
* Factor TimeZone stuff out of TrustyCms::Config into a module, fix failing tests. [Sean Cribbs]
* Add has_part?, inherits_part?, and has_or_inherits_part? methods to Page. [ana]
* Allow setting of local timezone via TrustyCms::Config and auto-adjustment of times in admin UI and <r:date /> tag. [Bodhi Philpot]
...
* Added support to TrustyCms::Config for boolean values [Sean Cribbs]
...
* Moved the images and stylesheets into images/admin and stylesheets/admin respectively to make it easier for TrustyCms's assets to coexist easily with the site's assets [John Long]
